...
const ShoppingCart = () => {
	...
	const handleCheckOut = () => {
		...
		setProducts([]);
		setOrderMessage('Your order has been accepted. Thank you for shopping with us!');
	};
				...
				<div className=' bg-gray-100 pt-20 h-screen'>
					...
					<div className='mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0'>
						...
						<div className='mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3'>
							...
							<button onClick={handleCheckOut} className='mt-6 w-full rounded-md bg-blue-500 py-4 font-medium  text-blue-50 hover:bg-blue-600'>
								Check out
							</button>
						</div>
					</div>
					...
					<div className='text-center'>
						...
						<Link href={'/products'}>
							<button className='button bg-blue-600 mt-4 text-white border-transparent hover:border-blue-600 hover:bg-transparent hover:text-black'>
								{orderMessage ? 'Continue Shopping' : 'Products'}
							</button>
						</Link>
					</div>
				</div>
